...
baseaddr := ReadMemory(0xA9C3D8, tpid)
xaddr := baseaddr + 0x590E98
yaddr := baseaddr + 0x590E9C
SetFormat, Integer, Dec
global targetX := ReadMemory(xaddr, tpid)
global targetY := ReadMemory(yaddr, tpid)
...
;address x 좌표 :  316D4A1C    4B00차이     316D8C1C          316D601C
;address y 좌표 :  316D4A18    4B00차이     316D8C18          316D6018
